...
const AddPassingGradeForm = ({ setOpenDialog, courseId }) => {
  ...
  async function onSubmit(data) {
    try {
      await fetchData('/course-passing-grades', {
        method: 'POST',
        body: JSON.stringify({
      ...
      toast({
        variant: 'success',
        title: 'Passing grade added successfully!'
      })
    } catch (exception) {
      const errorMessage = exception.message || 'Unable to add passing grade'
      toast({
        variant: 'destructive',
...
export default AddPassingGradeForm
